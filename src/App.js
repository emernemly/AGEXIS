...
function App() {
  ...
  return (
    <div className='App'>
      ...
      <Routes>
        <Route path='/' element={VerifAuth(<Home />)} />
        <Route
          path='/login'
        ...
        <Route path='/projet-realise' element={VerifAuth(<ProjetRealise />)} />
        <Route
        ...
        />
        <Route path='/reglementation' element={VerifAuth(<Reglementation />)} />
        <Route path='saviez-vous' element={VerifAuth(<SaviezVous />)} />
        <Route path='/environnement' element={VerifAuth(<EnvironnementRH />)} />
